...
public class DetailOrderController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(DetailOrderController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("DETAIL", odao.getOrderById(orderId));
            request.setAttribute("ORDER", ordao.getOrderDetailByOrderID(orderId));
        } catch (Exception e) {
            LOGGER.error("ERROR at DetailOrderController: " + e.getMessage());
        } finally {
